...
import { Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress, WETH9 } from 'panaromaswap_sdkcore'
import { abi } from 'panaromaswap_swaproutercontracts/artifacts/contracts/interfaces/ISwapRouter02.sol/ISwapRouter02.json'
import { Trade as V2Trade } from 'panaromaswap_v2sdk'
import {
  encodeRouteToPath,
  FeeOptions,
  MethodParameters,
...
/**
 * Represents the Panaromaswap V2 + V3 SwapRouter02, and has static methods for helping execute trades.
 */
